...
main (int argc, char **argv)
{
    ...
    t8_global_productionf ("Adapting, repartitioning, balancing this forest and creating a ghost layer.\n");
    forest = t8_adapt_partition_balance_ghost (forest);
    t8_global_productionf ("Adapted, repartitioned, balanced forest and build ghost layer.\n");
    t8_print_forest_information(forest);
